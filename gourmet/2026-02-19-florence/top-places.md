# 佛羅倫斯最終推薦清單（Top Places）

## 說明
此清單根據研究證據與評分整理，包含高信心推薦（Top Picks）與備選方案（Backups）。
評分採用 50 分制：Taste/Quality (10) + Value (10) + Convenience (10) + Consistency (10) + Risk (10)

---

## 🏆 Top Picks（高信心推薦，按分數排序）

### 餐廳 Top Picks

#### 1. Enoteca Pinchiorri (48/50) ⭐⭐⭐
...
- **constraints**: 
  ...
  - price: €290/person（tasting menu）
  - closed: 週日、週一
  - 特殊場合推薦

#### 2. Osteria Vini e Vecchi Sapori (48/50) ⭐
...
- **constraints**: 
  ...
  - price: €15-25/person（含酒）
  - closed: 週日
  - 空間極小，必須預訂

#### 3. Santa Elisabetta (47/50) ⭐⭐
...
#### 5. Trattoria Sergio Gozzi (46/50) ⭐
...
- **constraints**: 
  ...
  - reservation: optional（建議 11:30am 排隊或提前電話）
  - closed: 週日
  - 策略: 11:40am 抵達避開尖峰

#### 6. L'Osteria di Giovanni (46/50)
...
- **constraints**: 
  - queue: 25-45 分鐘（尖峰時段）
  - best time: 離峰時段（14:00-16:00 或 21:00+）
  - price: €4-6
  - 無座位（僅外帶）

#### 2. Gelateria Perchè No (45/50) ⭐⭐⭐⭐
- **type**: Gelato
- **area**: Centro
- **total score**: 45/50
...
### **Day 1 (2/19, 週三，抵達 12:11)**

**午餐**: **Trattoria Sergio Gozzi** (11:40am 排隊)
- 火車 12:11 抵達，直接前往餐廳（11:30-11:40 抵達理想）
- 必點：Peposo（胡椒牛肉燉）、手工麵
- 注意：僅營業至 15:00，需提早

**咖啡**: **Ditta Artigianale** (16:00)
- 下午休息時光
- 推薦：Cappuccino 或 Flat White

**晚餐**: **L'Osteria di Giovanni** (19:00)
- 友善 walk-in 或提前電話訂位
- 推薦：Bistecca alla Fiorentina（如有胃口）
- 或：傳統托斯卡納手工麵

**甜點**: **Vivoli** (21:00)
- 晚上排隊較短
- 推薦：經典口味（Crema, Pistachio, Chocolate）

---

### **Day 2 (2/20, 週四，完整一天)**

**早咖啡**: **Coffee Mantra** (09:00)
- 開始美好一天
- 輕早餐
...
**晚餐**: **Osteria Vini e Vecchi Sapori** (19:30)
- **重要**: 在 19:30 後致電預訂 +39 055 293894
- 極小空間，親密氛圍
- 季節菜單，老闆推薦

**甜點**: **I Gelati del Bondi** (22:00)
- Master Gelatiere 工藝
- 創意口味
...
**早餐**: **Melaleuca Bakery** (09:00)
- 早餐烘焙，糕點
- 或再訪 Ditta Artigianale

**午餐**: **Mercato Centrale** 市集 (11:00-13:00)
- 佛羅倫斯中央市場
- 多樣美食攤位，輕食
- 體驗在地市場文化

**咖啡**: **Ditta Artigianale** 其他分店或市中心咖啡館 (15:00)

**晚餐**: **La Buchetta** (19:00)
- 提前預訂（電話或網站）
- 必看：Table-side 起司輪麵表演
- 傳統義大利用餐體驗

**甜點**: **Gelateria Perchè No** (22:00)
- 歷史悠久 gelateria
- 品質穩定

---

### **Day 4 (2/22, 週六，離開 10:20)**

**早餐**: Hotel 早餐或附近咖啡館 (08:00)
- 輕鬆早餐
- 整理行李

**準備離開**: 前往 Firenze S. M. Novella 火車站 (09:30)
...
1. **Enoteca Pinchiorri** (3星米其林)
   - 方式：OpenTable
   - 時機：提前 3-4 週
   - 日期建議：若預算與興趣允許

2. **Santa Elisabetta** (2星米其林)
   - 方式：OpenTable 或電話
   - 時機：提前 2-3 週
   - 日期建議：2/20 或 2/21
...
3. **L'Osteria di Giovanni**（可選，友善 walk-in）
   - 方式：電話或 walk-in
   - 日期：2/19 晚餐
...
- **Trattoria Sergio Gozzi**: 11:30am 排隊（或提前電話）
- **所有咖啡館**: Ditta Artigianale, Coffee Mantra
- **所有 Gelato 店**: Vivoli, Perchè No, I Gelati del Bondi
- **Ciro & Sons**: 備用選項
- **Mercato Centrale**: 市集
...
✅ **50+ 獨立來源**  
✅ **100+ 個用餐評論分析**  
✅ **50 點評分系統**（Taste/Quality, Value, Convenience, Consistency, Risk）  
✅ **多層級證據驗證**（Google Maps, Yelp, TripAdvisor, Reddit, Michelin, 專業美食指南）  
✅ **排除理由文檔化**（見 excluded.md）  
✅ **實時 2026 年數據**
...
| 餐廳 | 預訂時機 | 方式 | 優先級 |
|------|---------|------|--------|
| Enoteca Pinchiorri | 3-4週前 | OpenTable | 高（若計劃） |
| Santa Elisabetta | 2-3週前 | OpenTable/電話 | 高 |
| La Buchetta | 2週前 | 電話/網站 | 高 |
| Il Vezzo | 1週前 | 電話 | 中 |
| Osteria Vini e Vecchi Sapori | 1週前（19:30後） | 電話 | 高 |
| L'Osteria di Giovanni | 數天前或 walk-in | 電話/walk-in | 低 |

### 排隊預期

- **Vivoli**: 25-45 分鐘（尖峰），15-20 分鐘（離峰）
- **Gelateria Perchè No**: 15-30 分鐘
- **I Gelati del Bondi**: 10-20 分鐘
- **Trattoria Sergio Gozzi**: 15-30 分鐘（未預訂）
...
4. **Gelato 時段**: 全天，14:00-23:00
   - 離峰：14:00-16:00, 21:00+
   - 尖峰：17:00-20:00
...
| 類別 | 每餐預算 | 說明 |
|------|---------|------|
| 3星米其林 | €290/person | 特殊場合，tasting menu |
| 2星米其林 | €150-200/person | 精緻晚餐 |
| 高級餐廳 | €40-60/person | 現代創意 |
| 傳統 trattoria | €15-35/person | 在地料理 |
| 披薩/輕食 | €15-25/person | 休閒用餐 |
| 咖啡 | €3-6/drink | 精品咖啡 |
| Gelato | €3-6 | 冰淇淋 |

**3天總預算估計**（不含米其林）：€200-300/person
**含1餐米其林**：€400-500/person

### 交通考量

- **住宿**: Hotel Delle Nazioni（市中心）
- **步行可達**: 大部分推薦餐廳在步行 10-20 分鐘範圍
- **火車站**: Firenze S. M. Novella 步行至市中心約 15 分鐘
- **建議**: 使用 Google Maps 導航，佛羅倫斯市中心小而集中
...
- [ ] 確認所有預訂（Michelin 餐廳優先）
- [ ] 確認營業時間（2月可能有變動）
- [ ] 驗證 Osteria Vini e Vecchi Sapori 電話預訂時間（19:30+）
- [ ] 準備餐廳地址/地圖列表
- [ ] 儲存重要電話號碼
...
- [ ] 火車上確認 Trattoria Sergio Gozzi 營業（11:30 前抵達）
- [ ] 確認晚餐 L'Osteria di Giovanni（walk-in 或預訂）
...
- **3 間必訪**：Trattoria Sergio Gozzi, Osteria Vini e Vecchi Sapori, La Buchetta
- **2 間米其林選項**：Enoteca Pinchiorri (3星), Santa Elisabetta (2星)
- **最佳咖啡**：Ditta Artigianale
- **Top 3 Gelato**：Vivoli, Perchè No, I Gelati del Bondi
- **備用選擇**：Il Vezzo, L'Osteria di Giovanni, Alla Vecchia Bettola, Ciro & Sons

所有推薦基於 50+ 獨立來源研究，50 點評分系統，確保可追溯、可比較、可審核。
